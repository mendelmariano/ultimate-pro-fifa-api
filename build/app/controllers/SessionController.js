...
var SessionController = /** @class */ (function () {
    ...
    SessionController.prototype.store = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, user, id, name, whatsapp;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            return [2 /*return*/, res.status(401).json({ error: 'Usuário não existe. ' })];
                        }
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, res.json({
                                ...
                                token: jsonwebtoken_1.default.sign({ id: id, user: user }, auth_1.default.secret, {
